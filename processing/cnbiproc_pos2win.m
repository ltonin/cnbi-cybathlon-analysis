function wPOS = cnbiproc_pos2win(POS, wshift, direction, wlength)
% wPOS = cnbiproc_pos2win(POS, wshift, edge, wlength)
%
% The function converts sample position (POS) to window (psd) position for 
% a given the window shift (wshift). direction argument refers to the way the
