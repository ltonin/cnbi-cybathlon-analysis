function [features, f] = cnbiproc_spectrogram(data, wlenght, wshift, pshift, samplerate, mlength)
% [features, f] = cnbiproc_spectrogram(data, wlenght, wshift, pshift, samplerate [, mlength])
%
